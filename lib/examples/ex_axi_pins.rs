...
fn main() {
    ...
    if let Some(mut wave) = Wave::from_env() {
        ...
        wave.add("awid", &inp.awid);
        wave.add("awaddr", &inp.awaddr);
        wave.add("awlen", &inp.awlen);
        wave.add("awsize", &inp.awsize);
        wave.add("awburst", &inp.awburst);
        wave.add("awlock", &inp.awlock);
        wave.add("awcache", &inp.awcache);
        wave.add("awprot", &inp.awprot);
        wave.add("awvalid", &inp.awvalid);
        wave.add("wdata", &inp.wdata);
        wave.add("wstrb", &inp.wstrb);
        wave.add("wlast", &inp.wlast);
        wave.add("wvalid", &inp.wvalid);
        wave.add("bready", &inp.bready);
        wave.add("arid", &inp.arid);
        wave.add("araddr", &inp.araddr);
        wave.add("arlen", &inp.arlen);
        wave.add("arsize", &inp.arsize);
        wave.add("arburst", &inp.arburst);
        wave.add("arlock", &inp.arlock);
        wave.add("arcache", &inp.arcache);
        wave.add("arprot", &inp.arprot);
        wave.add("arvalid", &inp.arvalid);
        wave.add("rready", &inp.rready);
        wave.add("b", &inp.b);
        wave.add("r", &inp.r);
        wave.add("aw", &outp.aw);
        wave.add("ar", &outp.ar);
