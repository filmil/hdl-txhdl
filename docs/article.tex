...
% One listing style for the language, one for plain ASCII figures. `'` is not
% a string delimiter here: the language uses it for loop labels, as Rust does.
\definecolor{cmtgray}{gray}{0.40}
