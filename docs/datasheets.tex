...
\input{datasheets/NoBeats}
\input{datasheets/NoReads}
...
\input{datasheets/EthSlots}
\input{datasheets/FrameOut}
\input{datasheets/FrameIn}
\input{datasheets/FrameLen}
\input{datasheets/EthShare}
...
\input{datasheets/Entropy}
\input{datasheets/Trng}
