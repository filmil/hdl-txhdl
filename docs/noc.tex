...
the netlist. Writes of more than one beat do not cross the network,
and are refused rather than carried; reads of several beats do cross,
since every beat of the answer is a packet of its own carrying its
identifier, and a test crosses the lattice with four of them.
Why the write is the hard one, what each way of carrying it would
cost, and which to build are worked out in \code{docs/noc-bursts.md},
which issue 125 implements.
