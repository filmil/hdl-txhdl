...
The arbiter in a switch is a fixed priority, and it starves: an input
that offers every cycle keeps its output, and the exit, which is last
in the order, moved nothing at all in two hundred cycles of a busy
link. That is issue 315, and it is a defect rather than a limit.
