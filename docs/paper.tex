...
external crate, an FST writer. Twenty-eight examples compile, each one
concept, and every one that runs writes a waveform the examples
document draws. Thirteen lowered units, Table~\ref{tab:p-checked}, are
...
thirty tests run under \code{bazel test //...}, and every one of them
