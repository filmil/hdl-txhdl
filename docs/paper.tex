...
installed by the build. Vreteno is 1132 lines of core, 78 of data
memory, 98 of timer,
62 of router and 89 of serial port, checked in lockstep against a
422-line model on a demonstration program and sixty-four random
ones, with interrupts raised at random, checked as a netlist on 647
