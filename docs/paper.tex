...
hardware, end to end, from a Rust source to a board that answers. Nine documents
...
mainline is public on GitHub, at \code{github.com/filmil/txhdl},
...
who opens an account on the instance.
