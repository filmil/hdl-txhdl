...
read the same way. \code{when!(c => \{ r <= v \})} is a predicated
drive: both arms exist, a multiplexer chooses, nothing branches.
\code{case!} is \code{when!} with many arms, Rust patterns with
