...
\author{Filip Filmar and Dragisa Janković%
...
\input{embedding_sections/03_values}
\input{embedding_sections/04_time}
\input{embedding_sections/05_pipeline}
\input{embedding_sections/06_units}
\input{embedding_sections/07_wiring}
\input{embedding_sections/08_binding}
\input{embedding_sections/09_main}
\input{embedding_sections/10_probes}
\input{embedding_sections/11_walls}
\input{embedding_sections/12_elaboration}
\input{embedding_sections/13_next}
\input{embedding_sections/14_conclusion}

\input{embedding_sections/15_appendix}
