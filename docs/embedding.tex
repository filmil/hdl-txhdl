...
already. Every claim here was compiled rather than argued, and two of those
compilations changed the design: arbitrary-width arithmetic needs nightly
Rust, and a unit's parallel processes cannot take \code{\&mut self}. One
...
\input{embedding_sections/01_introduction}
\input{embedding_sections/02_rule}
\input{embedding_sections/03_time}
\input{embedding_sections/04_pipeline}
\input{embedding_sections/05_units}
\input{embedding_sections/06_binding}
\input{embedding_sections/07_probes}
\input{embedding_sections/08_walls}
\input{embedding_sections/09_elaboration}
\input{embedding_sections/10_conclusion}
