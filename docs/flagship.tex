...
them, \code{//tools/remote/shim}; what is not is the run: the shim on
the machine the board is wired to, the program through a tunnel to
it, and the core reading back what the program computed. That is
issue~\#335, and it wants a cable rather than a design.
