...
The map and the table are of the flagship as it was placed before the
remote peripheral was added, since the extraction is a manual run of
Vivado on a routed checkpoint and the peripheral has not been through
one yet. It adds a small peripheral and two more of the same FIFO,
where the third bullet says the others landed.
