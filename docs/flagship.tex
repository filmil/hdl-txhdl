...
at \code{0x3200}, among the six in Table~\ref{tab:f-page}, with its
words in Table~\ref{tab:f-hdmi}. The tables are written by
\code{//tools/memmap} from the maps the router and the
