...
The core's router has six ports, one of them the boot memory, read-only
at address zero, and none to spare. The serial
...
third sixteenth, at \code{0x3200}, and the remote peripheral a fourth
at \code{0x3300}, so the bridge is a \code{LiteBridge<4, ..>}.
