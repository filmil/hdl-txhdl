...
what a state machine is made of. Rust's own \code{if} is there too,
...
have: an \code{if} that yields a value, a Rust \code{match}, a
function call the lowering does not know, or a loop with a variable
count. The macro says so at
