...
transaction's.
\item A read is answered on \code{bus\_r} with the word the answer
brought, and a write on \code{bus\_b}; either carries \code{SLVERR}
when the answer said the transaction failed or the wait ran out.
\end{itemize}
