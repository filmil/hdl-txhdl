...
It does not stop the stream on a difference. It holds a register,
\code{last}, that nothing drives and nothing reads, which is issue 287.
There is no timeout: two copies that stop offering stall the output for
ever.
