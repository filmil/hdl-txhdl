...
pins, an arbiter that puts the two onto one link, a router of six,
and the peripherals behind its six ports. The second host is Vivado's
...
\code{BoardRouter} states the map in its type, \code{Router6<32, 32, 4,
