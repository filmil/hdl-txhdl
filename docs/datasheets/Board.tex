...
\code{LiteBridge6}, a sixteenth of the page each: the serial port at
...
behind a \code{LiteBridge1} of their own; the module's lines go to
...
\code{BoardRouter} states the map in its type, \code{Router7<32, 32, 4,
4, ...>}. A peripheral gets an address when the address under the mask
equals the base.
...
\code{puart}, \code{LiteBridge6} at \code{0x3000} \\
...
\code{Plic3<0>} & \code{pplic}, \code{LiteBridge1} at
\code{0x0c00\_0000} \\
\code{0x1000\_0000} & \code{0xffff\_0000} & \code{dmod}, \code{Dm} &
\code{pdm}, \code{LiteBridge1} at \code{0x1000\_0000}; not nearer the
