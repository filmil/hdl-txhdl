...
go out on \code{bus\_ans} and \code{bus\_r}. It answers single-beat
bursts, which is all
...
\code{bus\_ans} has room. The whole beat is written to the word, and
\code{bus\_ans} sends \code{OKAY} with \code{pid}. The strobe is not read.
