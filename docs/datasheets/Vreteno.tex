...
\code{misa} is writable and ignores what is written. There are no
counters, so a read of \code{mcycle} or \code{minstret} still traps,
which is issue 299. It has one load in
