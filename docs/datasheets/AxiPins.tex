...
pins as one field, \code{pins}, an \code{AxiHostPins}, and the
\code{b} and \code{r} channels from the link. So its input ports are
\code{pins\_awid} and the rest beside \code{b} and \code{r}.
