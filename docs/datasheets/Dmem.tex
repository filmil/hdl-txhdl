...
\code{ans} has room. Each lane whose strobe bit is set takes its byte
of the beat, and \code{ans} sends \code{OKAY} with \code{pid}.
...
\code{//docs:vreteno\_sim\_dmem\_dmem\_tb\_test} and
