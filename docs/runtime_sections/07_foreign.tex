...
order as the timer of the core does. It does not lower through this
path, since what is lowered is the design and not the model; a
netlist holds a foreign module as a child of a unit of units instead,
through \code{netlist::foreign}, which the section on the macros
describes.
