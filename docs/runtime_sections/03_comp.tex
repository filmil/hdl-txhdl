...
each child its own process identity; \code{parallel!}, which keeps its
futures in one process and returns their outputs together; and the
executor, whose rules Section~\ref{sec:r-time} states.
