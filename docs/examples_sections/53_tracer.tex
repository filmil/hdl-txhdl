...
Its words, a control word, the count, the cursor and the four words of
the entry the cursor names, are declared once, with \code{regmap!},
which writes the word a read answers, the word a write goes to, and
the offsets the example addresses the buffer by (issue 672).
