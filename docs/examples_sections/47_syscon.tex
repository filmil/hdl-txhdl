...
scratch.
The seven are declared once, with \code{regmap!}, which writes the
word a read answers, the word a write goes to, and the offsets the
example addresses the block by (issue 671).
