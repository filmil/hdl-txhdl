...
lost, after which the rest of the byte is skipped. The lowering of
Sections~\ref{sec:x-seq} to~\ref{sec:x-hold} numbers the waits into a
state register the unit does not declare, forty-six states for the
twelve steps and four quarters the hand-written machine kept, and
the netlist agrees with the run under nvc and Verilator as before.
