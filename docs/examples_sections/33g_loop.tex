...
\code{router!} wrote \code{Router2} to \code{Router8}, and the
largest it wrote was the largest there was. A side of \code{run} may
now be an array of ports, \code{ins: [Rx<U<8>>; N]}, and the body may
go over it with \code{for i in 0..N} (issue 500); the router is one
unit over such arrays now, and the station is the one family still
written out.
