...
under the same conditions, and stated only while \code{rst} is low,
whether the netlist added the reset or the unit declared it: under
reset a register may not hold yet what it will, and an output may be
held on purpose (issue 633). The VHDL writes a check
