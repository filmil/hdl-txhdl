...
100~MHz with 0.309~ns of slack, in 1526 LUTs, 132 flip-flops, one
block RAM tile and the MMCM, with no critical warning.
...
since the demonstration program halts in sixty cycles; holding the
