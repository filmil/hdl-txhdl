...
hand around an MMCM. The design with the memory has not been
synthesised yet, and its figures are for the next change.
...
The design with the DDR3 memory, synthesised, placed and routed with
the memory's constraints, and then run on the board: what it takes,
how fast it runs, and whether the board says what the simulation
says.
