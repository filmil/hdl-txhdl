...
been programmed with \code{vreteno\_board\_ila\_prog}. That is the
half of the issue that wants the board. The bitstream has been
synthesised and routed; the capture waits for the next session at
the hardware, and the issue stays open for it.
