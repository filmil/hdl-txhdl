...
\code{ebreak} halts. The fetch reads a halfword, the upper half of its
...
reserved halfword that traps with itself as the trap value, and
\code{c.ebreak} to halt. Two more negative controls belong to it. With
