...
is what \code{halt} encodes and what a program ends with. The M extension is the
...
throughout, and then the same programs with one cycle of \code{fault},
after which the line is up and stays up to the end of the run.
