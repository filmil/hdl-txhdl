...
Together they are 65\,365 lines of Rust: 16\,654 of runtime
and macros, 18\,242 of parts, 13\,617 in ninety-seven examples, 13\,908 of
Vreteno with its board, and 2\,944 of Razboj, DDR3, Ethernet, HDMI,
PCIe and the SoC.
...
The examples' own units & examples & 59, in 50 files, all 50 \\
\bottomrule
\end{tabular}
\end{table}
...
its ports. \code{bazel test //...} runs three hundred and sixteen
targets, of
which a hundred and eighty-eight are netlists under both simulators; the rest are the
core's model and
