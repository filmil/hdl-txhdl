...
\code{//docs:cover}, names the twenty-two documents that say more.}%
...
Together they are 42\\,974 lines of Rust: 12\\,233 of runtime
and macros, 11\\,766 of parts, 8\\,024 in sixty-three examples, 8\\,033 of
...
its ports. \code{bazel test //...} runs a hundred and thirty-seven targets, of
which a hundred and eighteen are netlists under both simulators; the rest are the
core's model and
