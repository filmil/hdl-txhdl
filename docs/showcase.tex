...
from them. Together they are 33\,798 lines of Rust: 10\,591 of runtime
and macros, 8\,312 of parts, 6\,307 in fifty-three examples, 6\,119 of
Vreteno with its board, and 2\,469 of Razboj, DDR3, Ethernet, HDMI
and the SoC.
...
its ports. \code{bazel test //...} runs a hundred and eleven targets, of
which ninety-six are netlists under both simulators; the rest are the
core's model and
