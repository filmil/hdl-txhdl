...
from them. Together they are 30\,848 lines of Rust: 10\,327 of runtime
and macros, 7\,175 of parts, 5\,913 in fifty-one examples, 4\,964 of
...
Pins; Ethernet's three; HDMI's two & parts & all six \\
...
its ports. \code{bazel test //...} runs a hundred and five targets, of
which ninety-two are netlists under both simulators; the rest are the
core's model and
