...
two by two lattice and run together: the core says its line on the
port two hops away while the rasteriser draws into the memory they
share. The core pays eighteen per cent for the hops and the GPU pays
a little over twice, which is the difference between waiting for one
answer at a time and never waiting at all.
