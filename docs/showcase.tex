...
its ports. \code{bazel test //...} runs the eighty-two targets of
...
Test & Targets \\
\midrule
36 netlists, under \code{nvc} and under Verilator & 72 \\
The core: the model, the encoders, 2 programs & 4 \\
The GPU, 7 tests; the parts, 19; the SoC's run & 3 \\
...
\begin{tabular}{@{}lr@{}}
\toprule
The runtime and its macros & 9\,660 \\
Parts: the link, the router, the network & 4\,490 \\
Examples, forty-four of them & 4\,728 \\
Vreteno & 4\,178 \\
The GPU & 1\,550 \\
\bottomrule
\end{tabular}
