...
from them. Together they are 35\,106 lines of Rust: 10\,591 of runtime
...
its ports. \code{bazel test //...} runs a hundred and fourteen targets, of
...
the tools. Three more are tagged manual: the board and its DDR3 under
Vivado's simulator, and the AXI link's fuzzing over many seeds, which
the nightly run does. Every claim about what
