...
from them. Together they are 31\,351 lines of Rust: 10\,327 of runtime
...
with the I2C that configures the chip, general purpose pins, and a
bridge from AXI to Wishbone, which lets a controller written elsewhere
be a peripheral here.
...
its ports. \code{bazel test //...} runs a hundred and seven targets, of
...
Razboj has no depth buffer, no interpolation and no texture, and
