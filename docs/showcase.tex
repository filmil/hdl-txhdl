...
Together they are 58\,735 lines of Rust: 13\,329 of runtime
and macros, 17\,242 of parts, 11\,308 in seventy-nine examples, 13\,911 of
Vreteno with its board, and 2\,945 of Razboj, DDR3, Ethernet, HDMI,
PCIe and the SoC.
...
AXI arbiters, 2 to 8 hosts & parts & 2 \\
...
Interrupt controllers, 1 to 8 sources & parts & 3 \\
...
The examples' own units & examples & 40, in 30 files, all 30 \\
\bottomrule
\end{tabular}
\end{table}
...
its ports. \code{bazel test //...} runs two hundred and sixty-two
targets, of
which a hundred and fifty-two are netlists under both simulators; the rest are the
core's model and
