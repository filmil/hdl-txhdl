...
Together they are 35\,106 lines of Rust: 10\,591 of runtime
and macros, 9\,041 of parts, 6\,442 in fifty-four examples, 6\,119 of
Vreteno with its board, and 2\,913 of Razboj, DDR3, Ethernet, HDMI,
PCIe and the SoC.
...
Pins; SPI; Ethernet's three; HDMI's two & parts & all seven \\
...
with the I2C that configures the chip, general purpose pins, a system
control block that says which design is running and why it last
restarted, and a bridge from AXI to Wishbone, which lets a controller
written elsewhere be a peripheral here.
...
its ports. \code{bazel test //...} runs a hundred and thirteen targets, of
which ninety-eight are netlists under both simulators; the rest are the
core's model and
