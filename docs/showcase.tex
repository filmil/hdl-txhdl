...
Together they are 48\,848 lines of Rust: 12\,811 of runtime
and macros, 13\,725 of parts, 8\,851 in sixty-eight examples, 10\,536 of
...
The examples' own units & examples & 36, all but one \\
\bottomrule
\end{tabular}
\end{table}
...
The board & core, 6 devices, DDR3, a JTAG host & 3 runs, Vivado, the cable \\
...
its ports. \code{bazel test //...} runs two hundred and nineteen
targets, of
which a hundred and thirty are netlists under both simulators; the rest are the
core's model and
