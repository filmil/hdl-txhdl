...
\code{crate::funcs}. A multiply takes as long as the mapping decides, so
...
decide here. An adder the mapping gives zero latency is awaited and
completes at once, and the design that awaited it did not pay for the
question.
