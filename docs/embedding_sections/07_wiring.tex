...
\begin{lstlisting}[caption={A signal knows its clock. \code{Clock} is a marker trait, and the default is a named clock rather than an absence of one.},label={lst:clock}]
pub trait Clock { const NAME: &'static str; }
