...
every tick, while a deliberately broken one fails. A unit's second
process, the falling edge, memories, and a runtime channel that is a
cycle-accurate handshake, so that units with channels can be checked
too, are what remains.
