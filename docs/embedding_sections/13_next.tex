...
against its own trace. Of the three things known to be hard, control
flow across an await and resource sharing remain, and so do a unit's
second process and the falling edge.
