...
the counter, the blinky and the sequencer agree with their traces at
every tick, while a deliberately broken one fails. Memories lower,
and the runtime's channel is an elastic buffer with the handshake
registered on both sides, so a unit with channels is checked as any
other; a unit's second process and the falling edge are what remains.
