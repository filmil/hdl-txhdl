...
A wait under \code{if}, the control program with a branch in it, it
does not lower.
...
await is done for a plain sequence and a loop of a constant count and
not for a branch, and resource sharing remains.
