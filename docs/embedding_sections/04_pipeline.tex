...
\begin{lstlisting}[caption={A pipeline, a sequence and a parallel process, all at once. The await is the stage boundary, and \code{p} crosses it without being declared.},label={lst:pipeline}]
