...
to buy it back; \code{with!}, \code{case!} and \code{select!} are
...
against the trace of its own source, runs at 100~MHz on an Artix-7,
and has run on the board, where it said what its simulation said:
the language is proven on hardware. What the lowering does not read
yet is stated there, and it is the next thing to do.
