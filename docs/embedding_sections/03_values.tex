...
primitive and from \code{i32}, and its arithmetic and every drive take
anything that converts, so \code{acc.wrapping\_add(1)} and
\code{reg.set(0)} say what they mean. \code{i32} is there because an
