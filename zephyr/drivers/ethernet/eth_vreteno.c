...
#define VRETENO_ETH_RX_SLOT       0x00
#define VRETENO_ETH_RX_LENGTH     0x04
#define VRETENO_ETH_RX_EV_PENDING 0x08
#define VRETENO_ETH_RX_EV_ENABLE  0x0c
#define VRETENO_ETH_TX_SLOT       0x10
#define VRETENO_ETH_TX_LENGTH     0x14
#define VRETENO_ETH_TX_START      0x18
#define VRETENO_ETH_TX_READY      0x1c
#define VRETENO_ETH_TX_EV_PENDING 0x20
#define VRETENO_ETH_TX_EV_ENABLE  0x24

#define VRETENO_ETH_EVENT BIT(0)
